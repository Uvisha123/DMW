  ...
  <div class="container-fluid" id="main-content">
    ...
    <div class="col-md-3 mb-4">
        <div class="card text-center text-primary p-3">
            ...
            <h4 class="mt-2 mb-0" id="total_amt">LKR 0</h4> <!-- Unique ID for total_amt -->
        </div>
    </div>
    <div class="col-md-3 mb-4">
        <div class="card text-center text-success p-3">
            ...
            <h4 class="mt-2 mb-0" id="active_amt">LKR 0</h4> <!-- Unique ID for active_amt -->
        </div>
    </div>
    <div class="col-md-3 mb-4">
        <div class="card text-center text-danger p-3">
            ...
            <h4 class="mt-2 mb-0" id="cancelled_amt">LKR 0</h4> <!-- Unique ID for cancelled_amt -->
        </div>
    </div>
</div>
